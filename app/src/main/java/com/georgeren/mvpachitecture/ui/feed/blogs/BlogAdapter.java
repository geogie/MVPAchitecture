...
import com.georgeren.mvpachitecture.ui.base.BaseViewHolder;
...
public class BlogAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    public static final int VIEW_TYPE_EMPTY = 0;// 正常item
    public static final int VIEW_TYPE_NORMAL = 1;// 没有数据的时候
    ...
    public class ViewHolder extends BaseViewHolder {
        ...
        public void onBind(int position) {
            ...
            String urlPic = "";
            try {
                urlPic = URLDecoder.decode(blog.getCoverImgUrl(),"UTF-8");// url包含特殊字符，部分需要编码才能看到图片
            }catch (Exception e){
                e.printStackTrace();
            }
